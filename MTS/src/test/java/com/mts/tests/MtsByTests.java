...
public class MtsByTests {
    ...
    private com.mts.tests.HomePage homePage;
    ...
    public void setUp() {
        ...
        homePage = new com.mts.tests.HomePage(driver, wait);
    }
  ...
  //зЗаполняем поля и нажимаем продолжить
    @Test
